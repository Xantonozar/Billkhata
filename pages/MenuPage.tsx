                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl p-6 w-full max-w-4xl max-h-[90vh] overflow-y-auto" onClick={e => e.stopPropagation()}>
                    ...
                    <div className="space-y-6">
                        {permanentMenuData.map((item) => (
                            <div key={item.day} className="border-b pb-4 dark:border-gray-700 last:border-b-0">
                                <h3 className="font-semibold text-lg mb-3 text-gray-800 dark:text-gray-100">{item.day}</h3>
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                                    <div>
                                        <label className="text-sm font-semibold text-gray-700 dark:text-gray-300">Breakfast:</label>
                                        <input
                                            type="text"
                                    ...
                                    <div>
                                        <label className="text-sm font-semibold text-gray-700 dark:text-gray-300">Lunch:</label>
                                        <input
                                            type="text"
                                            value={item.lunch}
                                    ...
                                    <div>
                                        <label className="text-sm font-semibold text-gray-700 dark:text-gray-300">Dinner:</label>
                                        <input
                                            type="text"
                                            value={item.dinner}
                    ...
                    <div className="flex flex-wrap gap-3 mt-6 justify-end border-t pt-4 dark:border-gray-700">
                        ...
                        <button onClick={handleSavePermanent} className="px-4 py-2 bg-green-600 text-white font-semibold rounded-lg hover:bg-green-700">Save Permanent Menu</button>
                    </div>
                </div>
            </div>
        );
                ...
                {loading ? (
                    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-8 text-center">
                        <div className="flex justify-center items-center space-x-2">
                            ...
                            <span className="text-gray-600 dark:text-gray-300">Loading menu...</span>
                        </div>
                    </div>
                ) : (
