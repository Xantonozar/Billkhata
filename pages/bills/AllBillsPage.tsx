                        ...
                        <div key={bill.id} className="bg-white dark:bg-slate-800 rounded-xl shadow-md p-5 flex flex-col justify-between transition-all hover:shadow-lg hover:scale-[1.02]">
                            ...
                            <div className="mt-4 space-y-3">
                                ...
                                <div className="flex gap-2">
                                    <button onClick={() => setPage(`bills-detail_${bill.id}`)} className="px-3 py-1 text-sm bg-slate-100 dark:bg-slate-700 rounded-md font-semibold hover:bg-slate-200 dark:hover:bg-slate-600 transition-all active:scale-95">View Details</button>
                                </div>
                            </div>
                        </div>
                    );
                ...
                return (
                    <div key={bill.id} className="bg-white dark:bg-slate-800 rounded-xl shadow-md p-5 space-y-3 transition-all hover:shadow-lg">
                        ...
                        <div className="flex justify-between items-center border-t border-slate-200 dark:border-slate-700 pt-3">
                            ...
                            <button onClick={() => setPage(`bills-detail_${bill.id}`)} className="text-sm font-semibold text-primary-600 hover:underline">
                                View Details →
                            </button>
                        </div>
                    </div>
...
const AllBillsPage: React.FC = () => {
    ...
    const handleBillAdded = (newBill: Bill) => {
        // This would be an API call in a real app to persist the new bill
